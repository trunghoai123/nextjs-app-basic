...
// const Topbar = () => {
//   return (
//     <div className="h-[70px] px-5 py-4 justify-between bg-grayfc">
//       <div className="flex items-center">
//         <Link href={"/"} className="flex items-center">
//           <Image width={70} height={80} src="/logo.png" alt="yariga" />
//           <h1 className="text-primary font-bold text-[25px]">Yariga</h1>
//         </Link>
//       </div>
